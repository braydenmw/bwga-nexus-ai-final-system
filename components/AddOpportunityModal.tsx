...
export const AddOpportunityModal: React.FC<AddOpportunityModalProps> = ({ isOpen, onClose, onSave }) => {
    ...
    const inputStyles = "w-full p-3 bg-nexus-primary-900 border border-nexus-border-medium rounded-lg focus:ring-2 focus:ring-nexus-accent-brown focus:outline-none transition placeholder:text-nexus-text-muted text-nexus-text-primary";
