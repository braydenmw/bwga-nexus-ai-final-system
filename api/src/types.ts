...
export interface ReportParameters {
  ...
  partnershipType?: string; // New field for partnership context
  objectiveType?: string; // New field for objective type
}
...
// Additional types for ReportGenerator
export type EngagementStyle = 'exploratory' | 'strategic' | 'comprehensive';
export type ReportFormat = 'snapshot' | 'brief' | 'standard' | 'comprehensive';
